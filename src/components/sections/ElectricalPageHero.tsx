...
export interface ElectricalPageHeroProps {
  title: string;
  eyebrow?: string;
  eyebrowAfter?: string;
  body?: string;
    ...
    >
      {image ? (
        <>
          ...
          <div
            aria-hidden
            className="absolute inset-0 bg-gradient-to-r from-[hsl(var(--primary))] via-[hsl(var(--primary))]/90 to-[hsl(var(--primary))]/40"
          />
        </>
      ) : null}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-7 space-y-4">
            ...
            {badges ? <div className="pt-2">{badges}</div> : null}
          </div>
...
export default ElectricalPageHero;
