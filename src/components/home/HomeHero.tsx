...
import { ArrowRight, Phone, Palette, Sun, Shield } from "lucide-react";
...
const LICENSE_BADGES = [
  { icon: Palette, label: "Custom Wraps" },
  { icon: Sun, label: "Ceramic Tint" },
  { icon: Shield, label: "Paint Protection" },
] as const;
...
const HomeHero = () => {
  ...
  const heroImage =
    HOME_HERO.image ||
    resolveServiceImage("vehicle-wraps", MINHS_IMAGES.heroLuxury);
        ...
        <div className="relative z-10 flex flex-col justify-center py-12 lg:py-16 text-white">
          ...
          <div className="relative w-full px-4 sm:px-6 lg:pl-[max(1.5rem,calc((100vw-80rem)/2+1.5rem))] lg:pr-10 xl:pr-14">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                <Link to="/contact">
                  {HOME_HERO.secondaryCta?.label || "Contact Us"}
                </Link>
              </Button>
            </div>
