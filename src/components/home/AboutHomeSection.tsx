...
import { ABOUT_HOME } from "@/data/siteData";
      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="relative overflow-hidden rounded-sm minhs-card aspect-[4/3] lg:aspect-auto lg:min-h-[420px]">
            <img src={a.image} alt="Envision Wraps shop" className="absolute inset-0 w-full h-full object-cover" loading="lazy" />
            <div className="absolute inset-0 bg-gradient-to-t from-[hsl(var(--primary))]/60 to-transparent" />
          </div>
          <div>
            <p className="text-xs font-display font-bold uppercase tracking-[0.28em] text-[hsl(var(--envision-pink))]">
              {a.eyebrow}
            </p>
