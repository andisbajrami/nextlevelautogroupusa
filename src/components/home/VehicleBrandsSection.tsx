...
import { VEHICLE_BRANDS } from "@/data/siteData";
      ...
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="mt-4 text-muted-foreground leading-relaxed">
            From daily drivers to show cars — wraps, tint, and protection for the brands
            {COMPANY.name ? ` ${COMPANY.name} clients` : " clients"} bring in.
          </p>
        </div>
