      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          <div className="lg:col-span-4">
            <span className="inline-flex items-center gap-2 text-[hsl(var(--envision-pink))] text-xs font-bold uppercase tracking-[0.22em] font-display">
              <MapPin className="h-4 w-4" />
              Service Areas
            </span>
            <h2 className="mt-3 font-display text-3xl sm:text-4xl font-bold uppercase text-[hsl(var(--primary))] leading-tight">
              Serving Drivers
              <span className="block text-[hsl(var(--secondary))]">Near You</span>
            </h2>
