  ...
  return (
    <section className="bg-[hsl(var(--minhs-surface))] py-10 sm:py-12 lg:py-14">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[480px] rounded-lg overflow-hidden ring-1 ring-black/5 shadow-sm">
        {/* Dark left — bullets */}
        <div className="bg-[hsl(var(--primary))] text-white px-4 sm:px-6 lg:px-10 xl:px-14 py-12 lg:py-16 flex flex-col justify-center">
          ...
          <ul className="space-y-3 mt-8">
            {LEAD_FORM.bullets.map((b, i) => (
              <li key={b} className="flex items-start gap-3 text-sm sm:text-[15px] text-white/85">
                <span
                  className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-sm mt-0.5 ${
                    i % 2 === 1
                      ? "bg-[hsl(var(--envision-pink))]/15 border border-[hsl(var(--envision-pink))]/40"
                      : "bg-[hsl(var(--secondary))]/15 border border-[hsl(var(--secondary))]/35"
                  }`}
                >
                  <Check
                    className={`h-3.5 w-3.5 ${
                      i % 2 === 1 ? "text-[hsl(var(--envision-pink))]" : "text-[hsl(var(--secondary))]"
                    }`}
                    strokeWidth={2.5}
                  />
                </span>
          ...
          <form onSubmit={onSubmit} className="space-y-3 max-w-lg w-full mx-auto lg:mx-0 lg:max-w-none">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <input
                ...
                className="rounded-sm border border-[hsl(var(--border))] bg-[hsl(var(--minhs-surface))] text-[hsl(var(--primary))] placeholder:text-muted-foreground px-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-[hsl(var(--secondary))] focus:border-transparent"
              />
              <input
                type="tel"
                required
            ...
            <input
              ...
              className="w-full rounded-sm border border-[hsl(var(--border))] bg-[hsl(var(--minhs-surface))] text-[hsl(var(--primary))] placeholder:text-muted-foreground px-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-[hsl(var(--secondary))] focus:border-transparent"
            />
