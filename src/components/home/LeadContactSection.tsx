...
const LeadContactSection = () => {
  ...
  const fieldCls =
    "rounded-sm border border-[hsl(var(--border))] bg-[hsl(var(--minhs-surface))] text-[hsl(var(--primary))] placeholder:text-muted-foreground px-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-[hsl(var(--secondary))] focus:border-transparent";
          ...
          <div className="bg-white px-4 sm:px-6 lg:px-10 xl:px-14 py-12 lg:py-16 flex flex-col justify-center">
            <form onSubmit={onSubmit} className="space-y-3 max-w-lg w-full mx-auto lg:mx-0 lg:max-w-none">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <input name="vehicle_year" type="text" placeholder="Vehicle Year" className={fieldCls} />
              ...
              <textarea
                ...
                rows={4}
                className={`w-full ${fieldCls} resize-none`}
              />
              <Button
                type="submit"
                size="lg"
