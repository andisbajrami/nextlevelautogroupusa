...
const Footer = () => {
  ...
  return (
    <footer className="bg-[hsl(var(--minhs-dark-panel))] text-white">
      {/* Accent strip — logo blue → pink */}
      <div className="h-1.5 envision-brand-bar" aria-hidden />
            ...
            <Link to="/" className="inline-flex items-center gap-2.5 group">
              {logoUrl ? (
                <img
                  src={logoUrl}
                  alt={COMPANY.name}
                  className="h-14 sm:h-16 w-auto max-w-[220px] object-contain object-left"
                />
              ) : (
                <>
