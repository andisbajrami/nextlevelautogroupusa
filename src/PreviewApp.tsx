...
import {
  ...
  THEME_DEFAULTS,
  type ThemeConfig,
} from "@template-minhs/contexts/ThemeContext";
import {
  SiteContentProvider,
  SITE_CONTENT_DEFAULTS,
  type SiteContentState,
} from "@template-minhs/contexts/SiteContentContext";
...
import ScrollToTop from "@template-minhs/components/ScrollToTop";
import ChatbotWidget from "@template-minhs/components/Chatbot/ChatbotWidget";
import Index from "@template-minhs/pages/Index";
import NotFound from "@template-minhs/pages/NotFound";
...
const About = lazy(() => import("@template-minhs/pages/About"));
const Services = lazy(() => import("@template-minhs/pages/Services"));
const ServiceDetail = lazy(() => import("@template-minhs/pages/ServiceDetail"));
const Projects = lazy(() => import("@template-minhs/pages/Projects"));
const ProjectDetail = lazy(() => import("@template-minhs/pages/ProjectDetail"));
const Blog = lazy(() => import("@template-minhs/pages/Blog"));
const BlogPost = lazy(() => import("@template-minhs/pages/BlogPost"));
const Team = lazy(() => import("@template-minhs/pages/Team"));
const Contact = lazy(() => import("@template-minhs/pages/Contact"));
const FAQ = lazy(() => import("@template-minhs/pages/FAQ"));
const Reviews = lazy(() => import("@template-minhs/pages/Reviews"));
const ServiceAreas = lazy(() => import("@template-minhs/pages/ServiceAreas"));
const Careers = lazy(() => import("@template-minhs/pages/Careers"));
...
const PreviewApp = () => {
  ...
  const applyDraftPayload = useCallback((payload: Pick<Draft, "theme" | "content"> | null) => {
    if (!payload) return;
    setTheme(
      hydrateMinhsThemeConfig({
        ...THEME_DEFAULTS,
        ...(payload.theme as Partial<ThemeConfig>),
      }),
    );
    setContent(
      hydrateMinhsSiteContent(
