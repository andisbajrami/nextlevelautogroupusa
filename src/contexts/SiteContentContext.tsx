...
import { hydrateMinhsSiteContent } from "@/lib/media";
...
const STORAGE_KEY = "envision-site-content-v2";
const EXPORT_MARKER_KEY = "envision-export-applied-at-v2";
...
export const SITE_CONTENT_DEFAULTS: SiteContentState = {
  ...
  sectionVisibility: {
    "home.hero": true,
    "home.contactStrip": true,
    "home.trustBar": true,
    "home.residentialCommercial": true,
    "home.servicesRibbon": true,
    "home.troubleshooting": true,
    "home.whyTeam": true,
    "home.signatureProjects": true,
    "home.clientStories": true,
    "home.emergencyBand": true,
    "home.serviceAreas": true,
    "home.leadContact": true,
    "home.vehicleBrands": true,
    "home.warranty": true,
    "home.aboutHome": true,
    "home.faq": true,
    "home.ctaBanner": true,
      ...
      save({
        ...
        serviceSections: [
          ...state.serviceSections,
          {
            ...
            image: MINHS_IMAGES.emergencyScene,
      ...
      save({
        ...
        projects: [
          ...state.projects,
          {
            ...
            image: MINHS_IMAGES.galleryGarageRed,
            gallery: [],
