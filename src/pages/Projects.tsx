...
import { MINHS_IMAGES, PROJECTS_LATEST_PAGE_SIZE } from "@/data/siteData";
...
const Projects = () => {
  ...
  return (
    <Layout>
      ...
      <section className="bg-[hsl(var(--primary))] text-white py-14 lg:py-20 relative overflow-hidden min-h-[320px]">
        <img
        ...
        />
        <div aria-hidden className="absolute inset-0 bg-[hsl(var(--primary))]/85" />
        <div
          aria-hidden
